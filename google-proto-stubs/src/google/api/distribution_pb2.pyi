...
class Distribution(google.protobuf.message.Message):
    ...
    class BucketOptions(google.protobuf.message.Message):
        ...
        class Linear(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal[u"num_finite_buckets",b"num_finite_buckets",u"offset",b"offset",u"width",b"width"]) -> None: ...
        ...
        class Exponential(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal[u"growth_factor",b"growth_factor",u"num_finite_buckets",b"num_finite_buckets",u"scale",b"scale"]) -> None: ...

        class Explicit(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
            BOUNDS_FIELD_NUMBER: builtins.int
            bounds: google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float] = ...

            def __init__(self,
                *,
                bounds : typing.Optional[typing.Iterable[builtins.float]] = ...,
                ) -> None: ...
            def ClearField(self, field_name: typing_extensions.Literal[u"bounds",b"bounds"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"explicit_buckets",b"explicit_buckets",u"exponential_buckets",b"exponential_buckets",u"linear_buckets",b"linear_buckets",u"options",b"options"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"explicit_buckets",b"explicit_buckets",u"exponential_buckets",b"exponential_buckets",u"linear_buckets",b"linear_buckets",u"options",b"options"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"options",b"options"]) -> typing_extensions.Literal["linear_buckets","exponential_buckets","explicit_buckets"]: ...
    ...
    class Exemplar(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"attachments",b"attachments",u"timestamp",b"timestamp",u"value",b"value"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"bucket_options",b"bucket_options",u"range",b"range"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"bucket_counts",b"bucket_counts",u"bucket_options",b"bucket_options",u"count",b"count",u"exemplars",b"exemplars",u"mean",b"mean",u"range",b"range",u"sum_of_squared_deviation",b"sum_of_squared_deviation"]) -> None: ...
